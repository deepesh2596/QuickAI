  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
      <div className='text-center'>
        <h2 className='text-slate-700 text-[42px] font-semibold'>Next-Gen AI Suite</h2>
        <p className='text-gray-500 max-w-lg mx-auto'>All-in-one platform to create, refine, and elevate your content using advanced AI innovations.</p>
      </div>
